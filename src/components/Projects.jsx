  ...
  return (
    <div className="flex flex-col items-center text-center p-5 bg-customBackground gap-5 w-full max-w-screen-lg">
      ...
      <div className="flex flex-col md:flex-row items-start mt-8 md:mt-0 space-y-4 md:space-y-0 md:space-x-4 w-full">
        ...
        <div className="w-full md:w-1/3 text-left mt-0">
          <h2 className="text-2xl font-semibold mb-4">SocialNet</h2>
          <p className="text-lg mb-4">
            SocialNet is a social networking platform built with React and Node.js. It features user
            authentication, profile creation, friend requests, and interactive posts with likes and
            comments. My role included front-end and back-end development, ensuring responsiveness
