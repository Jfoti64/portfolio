const About = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center text-center p-5 bg-customBackground min-h-screen gap-5">
      <div className="flex flex-col items-center md:w-2/3">
        ...
        <p className="text-2xl mb-8 max-w-2xl">
          ...
          for film and traveling. Let&apos;s connect and build something amazing!
        </p>
      </div>
