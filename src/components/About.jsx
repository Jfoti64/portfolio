...
const About = () => {
  ...
  return (
    <div
      ref={aboutRef}
      className="opacity-0 transform translate-y-10 transition-all duration-1000 ease-in-out flex flex-col md:flex-row items-center justify-center text-center p-5 bg-customBackground gap-5 w-full max-w-screen-lg"
    >
